...
Any of the configuration options in the Further Configuration section can be added as to the acts_as_indexed method call.
...
Since +with_index+ is a named scope, WillPaginate can be used in the normal 
fashion.
